...
wire cout_1,oflow_1;
assign cout_1 = (mode == 1 && rst != 1) ? (
    (cmd == 0) ? add_result[N]  :
    (cmd == 2) ? addc_result[N] : 1'b0
) : 1'b0;
    ...
    if (rst) begin
        ...
        if (mode) begin
            ...
            case (cmd)
                ...
                1:  begin if (inp_valid == 2'b11)   begin res_d <= (((1<<N)-1)&(~(opa & opb))); err_d <= 0; end else err_d <= 1; end
                2:  begin if (inp_valid == 2'b11)   begin res_d <= opa | opb;    err_d <= 0; end else err_d <= 1; end
                3:  begin if (inp_valid == 2'b11)   begin res_d <= (((1<<N)-1)&(~(opa | opb))); err_d <= 0; end else err_d <= 1; end
                4:  begin if (inp_valid == 2'b11)   begin res_d <= opa ^ opb;    err_d <= 0; end else err_d <= 1; end
                5:  begin if (inp_valid == 2'b11)   begin res_d <= (((1<<N)-1)&(~(opa ^ opb))); err_d <= 0; end else err_d <= 1; end
                6:  begin if (inp_valid[0] == 1'b1) begin res_d <= (((1<<N)-1)&(~opa));         err_d <= 0; end else err_d <= 1; end
                7:  begin if (inp_valid[1] == 1'b1) begin res_d <= (((1<<N)-1)&(~opb));         err_d <= 0; end else err_d <= 1; end
                ...
                12: begin if (inp_valid == 2'b11)   begin res_d <= (((1 << N) - 1) & ((opa >> (N - opb[$clog2(N):0])) | (opa << (opb[$clog2(N):0])))); err_d<=(opb[N-1:N/2])?1:0; end else err_d<=1;end
                13: begin if (inp_valid == 2'b11)   begin res_d <= (((1 << N) - 1) & ((opa << (N - opb[$clog2(N):0])) | (opa >> (opb[$clog2(N):0]))));  err_d<=(opb[N-1:N/2])?1:0; end else err_d<=1;end
                default: begin
